...
import { registerAdmin } from "../../redux/auth/auth.actions";
...
const AdminSignup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const payload = { adminName: name, number: mobile, email, password };
      ...
      <>
        ...
        <Box className={Styles.container}>
          <VStack className={Styles.stackContainer}>
            <Heading fontWeight="500" width="100%" textAlign={"center"}>
